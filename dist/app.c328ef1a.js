...
var inputWeather = document.querySelector("#myInput");
var container = document.querySelector(".container");
var searchButton = document.getElementById("searchButton");
var apiKey = "d5e41fa96f9d475ab1f01013240307";
var weatherCity = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var city, res, cityData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          city = document.querySelector("#myInput").value;
          if (!(city === "")) {
            _context.next = 6;
            break;
          }
...
var weatherInfo = function weatherInfo(data) {
